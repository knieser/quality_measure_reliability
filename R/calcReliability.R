calcReliability <- function(df, model = NULL, y, provider, ctrPerf = controlPerf(), ctrRel = controlRel()){
  ...
  SSR.out <- calcSSR(df, model, y, provider, ctrPerf = ctrPerf, ctrRel = ctrRel)
