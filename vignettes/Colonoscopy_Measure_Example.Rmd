---
title: "Colonoscopy_Measure_Example"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Colonoscopy_Measure_Example}
...
Beta-Binomial parameter estimates are: alpha = `r round(BB.results$alpha,3)` and beta = `r round(BB.results$beta, 3)`. The between-entity variance in rates is `r round(BB.results$var.between, 3)`.
...
fig <- ggplot(data = plot.df, aes(x = n, y = rel)) +
  ...
  annotate('text', x = 1700, y = 0.92, label = 'Median reliability', size = 6, col = 'red', face = 'bold') +
