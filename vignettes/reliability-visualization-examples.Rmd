---
title: "reliability-visualization-examples"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{reliability-visualization-examples}
...
# Select parameters for visualizations
```{r}
rel = c(0.5, 0.7, 0.9)
sd.b = 1
p = rnorm(5, 0, sd.b)
...
# Plots for misclassification notion of reliability
```{r}
